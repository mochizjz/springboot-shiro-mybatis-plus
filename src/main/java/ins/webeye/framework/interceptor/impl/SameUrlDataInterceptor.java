package ins.webeye.framework.interceptor.impl;
...
import ins.webeye.framework.interceptor.RepeatSubmitInterceptor;
...
public class SameUrlDataInterceptor extends RepeatSubmitInterceptor
{
    ...
    @Override
    public Boolean isSqlAttack(HttpServletRequest request) {
        String reqPath = getRequestPath(request);
		if( !reqPath.contains("remove")&& !reqPath.contains("sdk/webrecord.js")){
            return true;
        }
