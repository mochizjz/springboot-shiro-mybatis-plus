package ins.webeye.project.tool.gen.controller;
...
import ins.webeye.framework.web.domain.CxSelect;
...
import ins.webeye.project.tool.gen.service.IGenTableColumnService;
import ins.webeye.project.tool.gen.service.IGenTableService;
...
public class GenController extends BaseController
{
    ...
    {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"webeye.zip\"");
