...
public class UserConstants
{
	...
	/** 简版SDK */
	public static final String SDK_TYPE_S = "S";
	/** 录制文件的后缀名 */
	...
	public interface OperType {
		...
		/** 主录制事件 */
		public static final String MAIN_NODE = "1";
		/** 子事件 */
		public static final String SUB_NODE = "0";
		/** 页面截屏 */
		public static final String CAPTURE = "2";
		/** 做的一个标记点 */
		public static final String TAG_NODE = "4";
